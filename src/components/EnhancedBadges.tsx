...
import Badge3DViewer from './animations/Badge3DViewer';
          ...
          >
            {filteredBadges.map((badge, index) => (
              <motion.div
                ...
                className={`relative group bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 cursor-pointer ${
                  badge.featured 
              ...
              >
                ...
                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="w-8 h-8 bg-yellow-400/20 rounded-full flex items-center justify-center">
                    <span className="text-yellow-400 text-xs font-bold">3D</span>
                  </div>
                </div>
              </motion.div>
            ))}
